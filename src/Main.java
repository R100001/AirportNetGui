...
public class Main {
	...
	public static void main(String[] args) {
		...
		ConnectionGraph airportGraph = new ConnectionGraph();

		findairportframe.linkAirportPage(airportpageframe);
		findairportframe.linkGraph(airportGraph);

		airportpageframe.linkFindAirportPage(findairportframe);
		airportpageframe.linkGraph(airportGraph);
	}
}